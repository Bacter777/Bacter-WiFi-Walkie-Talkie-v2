...
public class SwitchButton extends Button
{
    ...
    public SwitchButton( Context context, AttributeSet attrs, int defStyle )
    {
        ...
        m_pressedBackground = new ColorDrawable( getResources().getColor(android.R.color.holo_blue_bright) );
