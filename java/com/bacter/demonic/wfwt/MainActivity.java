...
public class MainActivity extends Activity implements WalkieService.StateListener, Channel.StateListener
{
    ...
    public void onCreate( Bundle savedInstanceState )
    {
        ...
        m_buttonTalk = findViewById( R.id.buttonTalk );
    }
    ...
    public boolean onOptionsItemSelected( MenuItem item )
    {
        ...
        switch (item.getItemId())
        {
            case R.id.actionSettings:
            {
                ...
                final EditText editText = dialogView.findViewById( R.id.editTextStationName );
                final SeekBar seekBar = dialogView.findViewById( R.id.seekBarVolume );
                final CheckBox checkBoxCheckWiFiStatusOnStart = dialogView.findViewById( R.id.checkBoxCheckWiFiStatusOnStart );
                final CheckBox checkBoxUseVolumeButtonsToTalk = dialogView.findViewById( R.id.checkBoxUseVolumeButtonsToTalk );
                final CheckBox checkBoxBackButtonExists = dialogView.findViewById( R.id.checkBoxBackButtonExits );
            ...
            case R.id.actionAbout:
            {
                ...
                dialogBuilder.setIcon(R.drawable.bacter);
                dialogBuilder.setView( dialogView );
            ...
            if (!manager.isWifiEnabled())
            {
                ...
                final DialogInterface.OnClickListener listener = new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        final CheckBox checkBox = dialogView.findViewById( R.id.checkBoxNeverAskAgain );
